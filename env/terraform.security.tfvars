...
deploy_security_resources     = true
deploy_landingzones_resources = false

# Configure the security resources settings.
configure_security_resources = {
  settings = {
    log_analytics = {
      enabled = true
      config = {
  ...
  location = "australiaeast"
  tags = {
    applicationName    = "Platform Security"
