...
Description: Controls whether to manage the security landing zone policies and deploy the security resources into the current Subscription context.
...
Description: Specifies the Subscription ID for the Subscription containing all security resources.
...
Description: If specified, module will skip creation of the security Resource Group and use existing.
...
Description: If specified, will set the resource name prefix for security resources (default value determined from "var.root\_id").
...
Description: If specified, will set the resource name suffix for security resources.
...
Description: Configuration settings for the "Security" landing zone resources.
...
Description: Returns the configuration settings for resources to deploy for the security solution.
