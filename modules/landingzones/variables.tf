...
variable "management_group_id" {
  type        = string
  description = "Specifies the ID of the Management Group to which subscription is associated."
  default     = ""
}
...
variable "deploy_landingzones_resources" {
  type        = bool
  description = "If set to true, will enable the landing zones settings."
  default     = false
}
